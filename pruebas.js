  ...
  foobarsdk={
    ...
    user:{
      ...
      setCustomUserAttribute:function(sanitizedKey, sanitizedValue){
        this[sanitizedKey]=sanitizedValue;
      },
  ...
  setUserAttribute("user-value", "$100");
//console.log(setUserAttribute("user-value", "$100"));
//foobarsdk.setCustomUserAttribute('name','pepe');
//foobarsdk.getUser().setCustomUserAttribute('address','NewYork');
//console.log(foobarsdk.getUser().setCustomUserAttribute('address','NewYork'));
console.log(foobarsdk.getUser());